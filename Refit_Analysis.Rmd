...
features_2017 <- within(features_2017, BulletB[BulletB == 1 & BarrelB == "A"] <- "A")
features_2017 <- within(features_2017, BulletB[BulletB == 1 & BarrelB == "B"] <- "B")
features_2017 <- within(features_2017, BulletB[BulletB == 1 & BarrelB == "C"] <- "C")
features_2017 <- within(features_2017, BulletB[BulletB == 1 & BarrelB == "D"] <- "D")
features_2017 <- within(features_2017, BulletB[BulletB == 1 & BarrelB == "E"] <- "E")
features_2017 <- within(features_2017, BulletB[BulletB == 1 & BarrelB == "F"] <- "F")
features_2017 <- within(features_2017, BulletB[BulletB == 1 & BarrelB == "G"] <- "G")
features_2017 <- within(features_2017, BulletB[BulletB == 1 & BarrelB == "H"] <- "H")
features_2017 <- within(features_2017, BulletB[BulletB == 1 & BarrelB == "I"] <- "I")
features_2017 <- within(features_2017, BulletB[BulletB == 1 & BarrelB == "J"] <- "J")
features_2017 <- within(features_2017, BulletB[BulletB == 1 & BarrelB == "L"] <- "L")
features_2017 <- within(features_2017, BulletB[BulletB == 1 & BarrelB == "M"] <- "M")
features_2017 <- within(features_2017, BulletB[BulletB == 1 & BarrelB == "N"] <- "N")
features_2017 <- within(features_2017, BulletB[BulletB == 1 & BarrelB == "Q"] <- "Q")
features_2017 <- within(features_2017, BulletB[BulletB == 1 & BarrelB == "R"] <- "R")
features_2017 <- within(features_2017, BulletB[BulletB == 1 & BarrelB == "S"] <- "S")
features_2017 <- within(features_2017, BulletB[BulletB == 1 & BarrelB == "U"] <- "U")
features_2017 <- within(features_2017, BulletB[BulletB == 1 & BarrelB == "V"] <- "V")
features_2017 <- within(features_2017, BulletB[BulletB == 1 & BarrelB == "W"] <- "W")
features_2017 <- within(features_2017, BulletB[BulletB == 1 & BarrelB == "X"] <- "X")
features_2017 <- within(features_2017, BulletB[BulletB == 1 & BarrelB == "Y"] <- "Y")
features_2017 <- within(features_2017, BulletB[BulletB == 1 & BarrelB == "Z"] <- "Z")
...
features_2017$BarrelB[features_2017$BarrelB == "A"] <- "Unknown"
features_2017$BarrelB[features_2017$BarrelB == "B"] <- "Unknown"
features_2017$BarrelB[features_2017$BarrelB == "C"] <- "Unknown"
features_2017$BarrelB[features_2017$BarrelB == "D"] <- "Unknown"
features_2017$BarrelB[features_2017$BarrelB == "E"] <- "Unknown"
features_2017$BarrelB[features_2017$BarrelB == "F"] <- "Unknown"
features_2017$BarrelB[features_2017$BarrelB == "G"] <- "Unknown"
features_2017$BarrelB[features_2017$BarrelB == "H"] <- "Unknown"
features_2017$BarrelB[features_2017$BarrelB == "I"] <- "Unknown"
features_2017$BarrelB[features_2017$BarrelB == "J"] <- "Unknown"
features_2017$BarrelB[features_2017$BarrelB == "L"] <- "Unknown"
features_2017$BarrelB[features_2017$BarrelB == "M"] <- "Unknown"
features_2017$BarrelB[features_2017$BarrelB == "N"] <- "Unknown"
features_2017$BarrelB[features_2017$BarrelB == "Q"] <- "Unknown"
features_2017$BarrelB[features_2017$BarrelB == "R"] <- "Unknown"
features_2017$BarrelB[features_2017$BarrelB == "S"] <- "Unknown"
features_2017$BarrelB[features_2017$BarrelB == "U"] <- "Unknown"
features_2017$BarrelB[features_2017$BarrelB == "V"] <- "Unknown"
features_2017$BarrelB[features_2017$BarrelB == "W"] <- "Unknown"
features_2017$BarrelB[features_2017$BarrelB == "X"] <- "Unknown"
features_2017$BarrelB[features_2017$BarrelB == "Y"] <- "Unknown"
features_2017$BarrelB[features_2017$BarrelB == "Z"] <- "Unknown"
...
#table(comparisons$Set)
#table(features_2017$Set)
...
#table(features_2017$compare_id)
#table(features_2017$profile1_id)
#table(features_2017$profile2_id)
```
...
features_2017 %>% 
  ...
  ggplot(aes(x = BarrelA, y = BarrelB))+
    geom_tile(aes(fill = count))+
      scale_fill_viridis(option = "plasma", direction = -1)+ 
        geom_text(aes(label = count))+ 
          ggtitle("Feature 2017 Tiles Showing This Terrible Mess!!!")+ 
            theme_bw()+ 
...
features_2017 %>% 
  filter(Set == "Hamby173") %>%
      group_by(profile1_id, Bullet1) %>% 
        summarise(count = n()) %>% 
  ggplot(aes(x = profile1_id, y = Bullet1))+
    geom_tile(aes(fill = count))+
      scale_fill_viridis(option = "plasma", direction = -1)+ 
          ggtitle("Features 2017 Profile_Id(Set = 173)")+ 
            theme_bw()+
              theme(axis.text.y = element_text(size= 9, angle=20)) #Just for exploration. 
...
features_2017 %>% 
  ...
  ggplot(aes(x = profile1_id, y = Bullet1))+
    geom_tile(aes(fill = count))+
      scale_fill_viridis(option = "plasma", direction = -1)+ 
          ggtitle("Features 2017 Profile_Id(Set = 252)")+ 
            theme_bw()+
              theme(axis.text.y = element_text(size= 9, angle=20)) #Just for exploration

```

#Everything past this point in for comparison data separatley.  There is still issues to be solved before Joining both data frames together.#
...
Bullet_Scores_Examin <- Bullet_Scores %>% tidyr::unnest(data)

Bullet_Scores_Examin %>% filter(samepath == "TRUE")


Bullet_Scores_Examin %>% filter(samepath == "FALSE")
```


Looking at whether two lands have the same source
samepath = 324 TRUEs
samepath = 87,876 FALSEs 

Looking at the variable "samepath" or in demo "samesource" we see that only Barrel "Unknown" bullets from both Hamby173 and Hamby252 are said to be from same source.  
