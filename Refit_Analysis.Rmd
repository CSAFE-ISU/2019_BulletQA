...
feature_id1 <- features_2017[!duplicated(features_2017[c("Bullet1","Bullet2")]),]
feature_id2 <- anti_join(features_2017, feature_id1)

feature_id1 <- na.omit(feature_id1)
feature_id2 <- na.omit(feature_id2)

scatter1 <- inner_join(comparison_split, feature_id1, by = c("Bullet1", "Bullet2"))
scatter2 <- inner_join(comparison_split, feature_id2, by = c("Bullet1", "Bullet2"))
...
#-------------------------------------------------------------------------------------------------------------------------------------------#
#Everything past this point is for comparison data.  There is still issues to be solved before Joining both data frames together.#
